					...
					<view class="goods-skus">
						...
						<view class="goods-price" v-if="goodsDetail.promotionPrice && ((isGroup && buyType === 'PINTUAN') || !isGroup)">
							<span v-if="goodsDetail.promotionPrice && !pointDetail">
								<span class="goods-price-promotionShow goods-price-bigshow">{{ unitPrice(goodsDetail.promotionPrice, undefined, 'before') }}</span>
							...
							<div class="promotion-box">
								<span class="goods-price-bigshow">{{ unitPrice(goodsDetail.price, undefined, 'before') }}</span>
						...
						<view v-else>
							...
							<div class="price-row flex" v-if="goodsDetail.salesModel === 'WHOLESALE'">
								<div class="goods-price" v-for="(item, index) in wholesaleList" :key="index">
									<span>
										<span class="goods-price-bigshow">{{ unitPrice(item.price, undefined, 'before') }}</span>
