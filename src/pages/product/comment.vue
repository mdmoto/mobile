        ...
        <view class="eva-section">
          ...
          <view class="eva-box" v-for="(item, index) in commDetail" :key="index">
            ...
            <view class="section-contant">
              ...
              <view class="img">
                <!-- 循环出用户评价的图片 -->
                <template v-for="(img, i) in splitImg(item.images)" :key="i">
                  <u-image width="140rpx" height="140rpx" :src="img" @click="preview(splitImg(item.images), i)">
                  </u-image>
                </template>
              </view>
              <view class="bot">
            ...
            <view class="commentStyle" v-if="item.reply">
              ...
              <view class="img">
                <!-- 循环出商家回复评价的图片 -->
                <template v-for="(replyImg, replyIndex) in splitImg(item.replyImage)" :key="replyIndex">
                  <u-image width="140rpx" height="140rpx" :src="replyImg"
