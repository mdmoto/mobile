<template>
  <view class="wrapper">
    ...
    <u-cell-group>
      <u-cell :arrow="false" :value="complainDetail.goodsName" title="投诉商品"></u-cell>
      <u-cell :arrow="false" :value="statusData[complainDetail.complainStatus]" title="投诉状态"></u-cell>
      <u-cell :arrow="false" :value="complainDetail.createTime" title="投诉时间"></u-cell>
      <u-cell :arrow="false" :value="complainDetail.complainTopic" title="投诉主题"></u-cell>
      <u-cell :arrow="false" :value="complainDetail.content" title="投诉内容"></u-cell>
    ...
    <u-cell-group>
      <u-cell :arrow="false" :value="complainDetail.appealTime || '暂无'" title="申诉时间"></u-cell>
      <u-cell :arrow="false" :value="complainDetail.appealContent || '暂无'" title="申诉内容"></u-cell>
    ...
    <u-cell-group>
      <u-cell :arrow="false" title="仲裁意见" :value="complainDetail.arbitrationResult || '暂无'"></u-cell>
    </u-cell-group>
  </view>
</template>
