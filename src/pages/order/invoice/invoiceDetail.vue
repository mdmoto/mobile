<template>
  <view class="invoice-detail">
    ...
    <u-cell-group :border="false">
      <u-cell title="发票类型" :border-top="false" :value="'增值税普通发票'" :arrow="false"></u-cell>
      <u-cell title="发票内容" :value="order.receiptContent" :arrow="false"></u-cell>
      <u-cell title="发票抬头" :value="order.receiptTitle" :arrow="false"></u-cell>
      <u-cell title="纳税人识别号" v-if="order.taxpayerId" :value="order.taxpayerId" :arrow="false"></u-cell>
    </u-cell-group>
    <!-- <u-cell-group :border="false" style="margin-top: 20rpx;">
      <u-cell title="订单状态" :border-top="false" :value="order.order_status_text" :arrow="false"></u-cell>
      <u-cell title="订单编号" :value="order.sn" :arrow="false"></u-cell>
    </u-cell-group> -->
